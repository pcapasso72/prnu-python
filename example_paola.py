...
def main():
    ...
    ff_dirlist = np.array(sorted(glob('test/data/HTCU11/enrollment/*.jpg')))
    ...
    nat_dirlist = np.array(sorted(glob('test/data/HTCU11/training/*.jpg')))
    ...
    print('TPR on CC {:.2f}'.format(stats_cc['tpr']))
    print('FPR on CC {:.2f}'.format(stats_cc['fpr']))
    print('TPR on PCE {:.2f}'.format(stats_pce['tpr']))
    print('FPR on PCE {:.2f}'.format(stats_pce['fpr']))
